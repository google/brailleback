...
public class BrailleInputEvent implements Parcelable {
  ...
  /**
   * Returns a string representation of {@code command}, or the string {@code (unknown)} if the
   * command is unknown.
   */
  ...
  /**
   * Returns the command corresponding to {@code commandName}, or {@link #CMD_NONE} if the name
