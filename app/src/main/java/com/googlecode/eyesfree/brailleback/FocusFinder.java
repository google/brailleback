...
public class FocusFinder {
  ...
  private static AccessibilityNodeInfoCompat findFirstFocusableDescendantInternal(
    ...
    for (int i = 0, end = root.getChildCount(); i < end; ++i) {
      ...
      AccessibilityNodeInfoCompat n =
          findFirstFocusableDescendantInternal(child, context, seenNodes);
      if (n != null) {
        return n;
      }
    }
  ...
  private static AccessibilityNodeInfoCompat findLastFocusableDescendantInternal(
      AccessibilityNodeInfoCompat root,
      Context context,
      HashSet<AccessibilityNodeInfoCompat> seenNodes) {
    for (int end = root.getChildCount(), i = end - 1; i >= 0; --i) {
      ...
      AccessibilityNodeInfoCompat n =
          findLastFocusableDescendantInternal(child, context, seenNodes);
      if (n != null) {
        return n;
      }
