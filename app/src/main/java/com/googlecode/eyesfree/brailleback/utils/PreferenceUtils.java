...
public class PreferenceUtils {
  ...
  /**
   * Initializes the {@link LogUtils} log level from the shared preferences. In debug builds, this
   * is locked to be "VERBOSE". In release builds, it is user-configurable.
   */
  ...
  /**
   * Returns the appropriate log level to use, given the build type and user preferences. In debug
   * builds, this is forced to be "VERBOSE".
   */
