...
public class BrailleKeyBindingUtils {
  ...
  public static String getFriendlyKeyNamesForCommand(
    ...
    String keys =
        TextUtils.join(delimiter, getFriendlyKeyNames(binding.getKeyNames(), friendlyKeyNames));
  ...
  public static String[] getFriendlyKeyNames(
      String[] unfriendlyNames, Map<String, String> friendlyNames) {
