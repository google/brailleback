...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
   ...
   *
   * @param host The view whose virtual hierarchy is exposed by this helper.
   */
  ...
  /**
   * Dispatches hover {@link MotionEvent}s to the virtual view hierarchy when the Explore by Touch
   * feature is enabled.
   *
   * <p>This method should be called by overriding {@link View#dispatchHoverEvent}:
   *
   * <pre>
   * &#64;Override
   ...
   *
   * <p>You <b>must</b> call this method after adding or removing items from the parent view.
   */
   ...
   *
   * <p>You <b>must</b> call this method after changing any of the properties set in {@link
   ...
   * the correct state.
   *
   * @param virtualViewId The virtual view id for the item currently being hovered, or {@code
   *     #INVALID_ID} if no item is hovered within the parent view.
   */
  ...
  /**
   * Constructs and returns an {@link AccessibilityNodeInfoCompat} for the specified item.
   * Automatically manages accessibility focus actions.
   *
   * <p>Allows the implementing class to specify most node properties, but overrides the following:
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Uses the bounds of the parent view and the parent-relative bounding rectangle specified by
   * {@link AccessibilityNodeInfoCompat#getBoundsInParent} to automatically update the following
   * properties:
   *
   * <ul>
   *   <li>{@link AccessibilityNodeInfoCompat#setVisibleToUser}
  ...
  /** Exposes a virtual view hierarchy to the accessibility framework. Only supported in API 16+. */
  private AccessibilityNodeProviderCompat mNodeProvider =
  ...
  /**
   * Returns the virtual view id for the item under the specified parent-relative coordinates.
   *
  ...
  /**
   * Populates a list with the parent view's visible items. The ordering of items within {@code
   * virtualViewIds} specifies order of accessibility focus traversal.
   *
   ...
   *
   * <ul>
   *   <li>event text, see {@link AccessibilityEvent#getText()} or {@link
   ...
   *
   * <ul>
   *   <li>item class name, see {@link AccessibilityEvent#setClassName(CharSequence)}
   *   <li>package name, see {@link AccessibilityEvent#setPackageName(CharSequence)}
   ...
   *
   * <ul>
   *   <li>event text, see {@link AccessibilityNodeInfoCompat#setText(CharSequence)} or {@link
   *       AccessibilityNodeInfoCompat#setContentDescription(CharSequence)}
   *   <li>parent-relative bounds, see {@link AccessibilityNodeInfoCompat#setBoundsInParent(Rect)}
   * </ul>
   *
   * <p>The helper class automatically populates some required fields:
   *
   ...
   * </ul>
   *
   * @param virtualViewId The virtual view id for the item for which to populate the node.
   ...
   *
   * <p>Developers <b>must</b> handle any actions added manually in {@link
   * #populateNodeForVirtualViewId}.
   *
   ...
   *
   * @param virtualViewId The virtual view id for the item on which to perform the action.
