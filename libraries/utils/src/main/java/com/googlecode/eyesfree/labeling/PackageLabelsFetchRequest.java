...
public class PackageLabelsFetchRequest {
  ...
  public interface OnLabelsFetchedListener {
     ...
     *
     * @param results A {@link Map} containing that labels for the requested package name where the
     *     the key is the label's view resource ID name and the value is the associated {@link
     *     Label}.
     */
