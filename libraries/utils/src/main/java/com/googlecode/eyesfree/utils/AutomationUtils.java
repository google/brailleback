...
public class AutomationUtils {
  ...
  public static boolean performActionOnView(
      ...
      int action,
      Bundle arguments) {
    final List<AccessibilityNodeInfoCompat> matches =
        findViewsWithText(context, root, className, text);
    if (matches.size() != 1) {
      return false;
    }
  ...
  private static List<AccessibilityNodeInfoCompat> findViewsWithText(
      Context context, AccessibilityNodeInfoCompat root, CharSequence className, String text) {
