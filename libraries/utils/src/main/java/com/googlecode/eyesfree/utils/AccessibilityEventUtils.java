...
public class AccessibilityEventUtils {
  ...
  /**
   * Determines if the generating class of an {@link AccessibilityEvent} is an instance of a given
   * {@link Class}.
   *
   * @param context The application context.
   * @param event An {@link AccessibilityEvent} dispatched by the accessibility framework.
   * @param referenceClassName The name of a {@link Class} to match by type or inherited type.
   * @return {@code true} if the {@link AccessibilityEvent} object matches the {@link Class} by type
   *     or inherited type, {@code false} otherwise.
   */
