...
public class PackageManagerUtils {
  ...
  /**
   * Returns a developer-provided description for the primary application of the provided package
   * name. If the developer provided no name, the package name is used. If the package is not
   * installed on the system, {@code null} is returned.
   *
   * @param context {@link Context} used to resolve package information
   * @param packageName The package name of the application
   * @return A developer-provided description of the application, or {@code null} if the package is
