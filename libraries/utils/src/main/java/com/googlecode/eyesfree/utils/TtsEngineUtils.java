...
public class TtsEngineUtils {
   ...
   * SecureCompatUtils#TTS_DEFAULT_LOCALE}, failing which the old style value from {@link
   * Settings.Secure#TTS_DEFAULT_LANG} is read. If both these values are empty, the default phone
   * locale is returned.
   *
  ...
  public static Locale getDefaultLocaleForEngine(Context context, String engineName) {
    ...
    final String defaultLocalePref =
        Settings.Secure.getString(resolver, SecureCompatUtils.TTS_DEFAULT_LOCALE);
  ...
  /**
   * Returns whether speech synthesis using a specific language on the specified TTS requires a
   * network connection.
   *
   ...
   */
  public static final Comparator<TtsEngineInfo> ENGINE_PRIORITY_COMPARATOR =
