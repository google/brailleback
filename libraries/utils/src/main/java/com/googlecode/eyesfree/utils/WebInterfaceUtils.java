...
public class WebInterfaceUtils {
   ...
   *
   * <p>This property represents a boolean value encoded as an integer (1 is true, 0 is false).
   */
  ...
  /**
   * Action argument to use with {@link #performSpecialAction(AccessibilityNodeInfoCompat, int)} to
   * instruct ChromeVox to read the currently focused element within the node. within the page.
   */
  ...
  /**
   * Action argument to use with {@link #performSpecialAction(AccessibilityNodeInfoCompat, int,
   * int)} to instruct ChromeVox to move into or out of the special content navigation mode.
   *
  ...
  /**
   * Action argument to use with {@link #performSpecialAction(AccessibilityNodeInfoCompat, int,
   * int)} to instruct ChromeVox to move into or out of the incremental search mode.
   *
   ...
   * #performNavigationToHtmlElementAction(AccessibilityNodeInfoCompat, int, String)} to instruct
   * ChromeVox to move to the next or previous page section.
   */
   ...
   * HTML element argument to use with {@link
   * #performNavigationToHtmlElementAction(AccessibilityNodeInfoCompat, int, String)} to instruct
   * ChromeVox to move to the next or previous list.
   */
   ...
   * HTML element argument to use with {@link
   * #performNavigationToHtmlElementAction(AccessibilityNodeInfoCompat, int, String)} to instruct
   * ChromeVox to move to the next or previous control.
   */
  ...
  /**
   * @return {@code true} if the user has explicitly enabled injection of accessibility scripts into
   *     web content.
   */
  public static boolean isScriptInjectionEnabled(Context context) {
    final int injectionSetting =
        Settings.Secure.getInt(context.getContentResolver(), ACCESSIBILITY_SCRIPT_INJECTION, 0);
