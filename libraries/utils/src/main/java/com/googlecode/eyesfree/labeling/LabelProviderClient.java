...
public class LabelProviderClient {
  ...
  private static final String GET_LABELS_FOR_APPLICATION_QUERY_WHERE =
      new StringBuilder()
          .append(LabelsTable.KEY_PACKAGE_NAME)
          .append(EQUALS_ARGUMENT)
          .append(AND)
          .append(LabelsTable.KEY_LOCALE)
          .append(EQUALS_ARGUMENT)
          .append(AND)
          .append(LabelsTable.KEY_PACKAGE_VERSION)
          .append(LEQ_ARGUMENT)
          .toString();
  private static final String GET_LABEL_QUERY_WHERE =
      new StringBuilder()
          .append(LabelsTable.KEY_PACKAGE_NAME)
          .append(EQUALS_ARGUMENT)
          .append(AND)
          .append(LabelsTable.KEY_VIEW_NAME)
          .append(EQUALS_ARGUMENT)
          .append(AND)
          .append(LabelsTable.KEY_LOCALE)
          .append(EQUALS_ARGUMENT)
  ...
  private static final String PACKAGE_SUMMARY_QUERY_WHERE =
      new StringBuilder().append(LabelsTable.KEY_LOCALE).append(EQUALS_ARGUMENT).toString();
  ...
  public Map<String, Label> getLabelsForPackage(
    ...
    final String[] whereArgs =
        new String[] {packageName, locale, Integer.toString(maxPackageVersion)};
   ...
   * @param maxPackageVersion The maximum package version for result labels.
   * @return A single label matching the criteria, or {@code null} if no matching label was found.
   */
  public Label getLabel(String packageName, String viewName, String locale, int maxPackageVersion) {
    LogUtils.log(
        this,
        Log.DEBUG,
        "Querying single label: " + "packageName=%s, viewName=%s, locale=%s, maxPackageVersion=%s.",
        packageName,
        viewName,
        locale,
        maxPackageVersion);
    ...
    final String[] whereArgs =
        new String[] {packageName, viewName, locale, Integer.toString(maxPackageVersion)};
    Cursor cursor = null;
    try {
      cursor =
          mClient.query(
