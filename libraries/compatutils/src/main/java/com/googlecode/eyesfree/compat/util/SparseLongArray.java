...
package com.googlecode.eyesfree.compat.util;

/**
 * SparseLongArrays map integers to longs. Unlike a normal array of longs, there can be gaps in the
 * indices. It is intended to be more efficient than using a HashMap to map Integers to Longs.
 *
 * <p>Pulled from //frameworks/base/core/java/android/util/ on 6/11/2013 by
...
public class SparseLongArray implements Cloneable {
  ...
  /**
   * Gets the long mapped from the specified key, or the specified value if no such mapping has been
   * made.
   */
   ...
   * </code>th key-value mapping that this SparseLongArray stores.
   */
