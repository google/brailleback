...
public class SurfaceControlCompatUtils {
  ...
  private static final Class<?> CLASS_Surface_Control =
      CompatUtils.getClass("android.view.SurfaceControl");
  private static final Method METHOD_screenshot_II =
      CompatUtils.getMethod(CLASS_Surface_Control, "screenshot", int.class, int.class);
  ...
  /**
   * Copy the current screen contents into a bitmap and return it. Use width = 0 and height = 0 to
   * obtain an unscaled screenshot.
   *
