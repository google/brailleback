 ...
 */
LIBLOUIS_API
formtype EXPORT_CALL lou_getTypeformForEmphClass(const char *tableList,
                                                 const char *emphClass);
 ...
 */
LIBLOUIS_API
const char *EXPORT_CALL lou_getTableInfo(const char *table, const char *key);
 ...
 */
LIBLOUIS_API
const char **EXPORT_CALL lou_listTables();
