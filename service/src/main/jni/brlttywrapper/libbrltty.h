 ...
 */
int brltty_initialize(const char *driverCode, const char *brailleDevice,
 ...
 * time.
 */
int brltty_readCommand(int *readDelayMillis);
 ...
 * with blank cells.
 */
int brltty_writeWindow(unsigned char *dotPattern, size_t size);
 ...
 */
int brltty_listKeyMap(KeyMapEntryCallback callback, void *data);
