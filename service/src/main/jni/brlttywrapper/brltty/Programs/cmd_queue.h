...
extern int pushCommandEnvironment(const char *name,
...
extern int pushCommandHandler(const char *name, KeyTableCommandContext context,
                              CommandHandler *handler,
                              CommandDataDestructor *destructor, void *data);
