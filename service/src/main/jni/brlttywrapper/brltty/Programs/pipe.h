...
#define NAMED_PIPE_INPUT_CALLBACK(name) \
  size_t name(const NamedPipeInputCallbackParameters *parameters)
typedef NAMED_PIPE_INPUT_CALLBACK(NamedPipeInputCallback);

extern NamedPipeObject *newNamedPipeObject(const char *name,
