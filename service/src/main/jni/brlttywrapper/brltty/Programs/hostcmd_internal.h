...
extern int processHostCommandStreams(HostCommandStream *hcs,
...
extern int runCommand(int *result, const char *const *command,
                      HostCommandStream *streams, int asynchronous);
