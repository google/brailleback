...
extern SerialFlowControl serialPutFlowControl(SerialAttributes *attributes,
...
extern int serialPutAttributes(SerialDevice *serial,
                               const SerialAttributes *attributes);
...
extern ssize_t serialGetData(SerialDevice *serial, void *buffer, size_t size,
                             int initialTimeout, int subsequentTimeout);

extern ssize_t serialPutData(SerialDevice *serial, const void *data,
                             size_t size);

extern int serialGetLines(SerialDevice *serial);
extern int serialPutLines(SerialDevice *serial, SerialLines high,
                          SerialLines low);
