...
static ssize_t brl_writePacket(BrailleDisplay *brl, const void *buffer,
                               size_t size);
...
static int brl_keyToCommand(BrailleDisplay *brl, KeyTableCommandContext context,
                            int key);
...
const BrailleDriver BRLSYMBOL = {DRIVER_DEFINITION_INITIALIZER,
