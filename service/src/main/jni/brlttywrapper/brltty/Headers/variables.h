...
extern VariableNestingLevel *newVariableNestingLevel(
    VariableNestingLevel *previous, const char *name);
extern VariableNestingLevel *removeVariableNestingLevel(
    VariableNestingLevel *vnl);

extern VariableNestingLevel *claimVariableNestingLevel(
    VariableNestingLevel *vnl);
extern void releaseVariableNestingLevel(VariableNestingLevel *vnl);

extern void listVariables(VariableNestingLevel *from);
extern const Variable *findReadableVariable(VariableNestingLevel *vnl,
                                            const wchar_t *name, int length);
extern Variable *findWritableVariable(VariableNestingLevel *vnl,
                                      const wchar_t *name, int length);
...
extern void getVariableName(const Variable *variable,
                            const wchar_t **characters, int *length);
extern void getVariableValue(const Variable *variable,
                             const wchar_t **characters, int *length);

extern int setStringVariable(VariableNestingLevel *vnl, const char *name,
                             const char *value);
extern int setStringVariables(VariableNestingLevel *vnl,
