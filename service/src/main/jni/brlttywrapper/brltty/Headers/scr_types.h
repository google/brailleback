...
typedef enum {
  ...
  SCR_MASK_FG = SCR_ATTR_FG_RED | SCR_ATTR_FG_GREEN | SCR_ATTR_FG_BLUE |
                SCR_ATTR_FG_BRIGHT,
  ...
  SCR_COLOUR_FG_LIGHT_GREY =
      SCR_ATTR_FG_RED | SCR_ATTR_FG_GREEN | SCR_ATTR_FG_BLUE,
  ...
  SCR_COLOUR_BG_LIGHT_GREY =
      SCR_ATTR_BG_RED | SCR_ATTR_BG_GREEN | SCR_ATTR_BG_BLUE,
