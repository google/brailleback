...
typedef void SetSpeechVolumeMethod(volatile SpeechSynthesizer *spk,
                                   unsigned char setting);
typedef void SetSpeechRateMethod(volatile SpeechSynthesizer *spk,
                                 unsigned char setting);
typedef void SetSpeechPitchMethod(volatile SpeechSynthesizer *spk,
                                  unsigned char setting);
typedef void SetSpeechPunctuationMethod(volatile SpeechSynthesizer *spk,
...
typedef void SetSpeechLocationMethod(volatile SpeechSynthesizer *spk,
                                     int location);
...
typedef struct {
  ...
  void (*say)(volatile SpeechSynthesizer *spk, const unsigned char *text,
              size_t length, size_t count, const unsigned char *attributes);
