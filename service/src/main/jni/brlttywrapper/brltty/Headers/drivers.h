...
extern int haveDriver(const char *code, const char *codes,
                      const DriverEntry *table);
extern const char *getDefaultDriver(const DriverEntry *table);

extern const void *loadDriver(const char *driverCode, void **driverObject,
                              const char *driverDirectory,
                              const DriverEntry *driverTable,
                              const char *typeName, char typeLetter,
                              const char *symbolPrefix, const void *nullAddress,
                              const DriverDefinition *nullDefinition);

extern void identifyDriver(const char *type, const DriverDefinition *definition,
                           int full);
