...
extern int validateInteger(int *value, const char *string, const int *minimum,
                           const int *maximum);
extern int validateChoice(unsigned int *value, const char *string,
...
static inline const char *getFlagKeyword(const FlagKeywordPair *fkp,
                                         int state) {
...
static inline const char *getFlagKeywordOnOff(int state) {
  return getFlagKeyword(&fkpOnOff, state);
}

static inline const char *getFlagKeywordTrueFalse(int state) {
  return getFlagKeyword(&fkpTrueFalse, state);
}

static inline const char *getFlagKeywordYesNo(int state) {
  return getFlagKeyword(&fkpYesNo, state);
}

static inline const char *getFlagKeyword10(int state) {
  return getFlagKeyword(&fkp10, state);
}

extern int validateFlagKeyword(unsigned int *value, const char *string);
extern int validateFlag(unsigned int *value, const char *string,
                        const FlagKeywordPair *fkp);
...
extern int validateFloat(float *value, const char *string, const float *minimum,
                         const float *maximum);
#endif /* NO_FLOAT */
...
extern char **getParameters(const char *const *names, const char *qualifier,
                            const char *parameters);
extern void logParameters(const char *const *names, char **values,
