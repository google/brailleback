...
#define SERIAL_DEFAULT_PARAMETERS                                        \
  .baud = SERIAL_DEFAULT_BAUD, .dataBits = SERIAL_DEFAULT_DATA_BITS,     \
  .stopBits = SERIAL_DEFAULT_STOP_BITS, .parity = SERIAL_DEFAULT_PARITY, \
  .flowControl = SERIAL_DEFAULT_FLOW_CONTROL

#define SERIAL_PARAMETERS_INITIALIZER \
