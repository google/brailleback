...
extern MenuItem *newTextMenuItem(Menu *menu, const MenuString *name,
                                 const char *text);

extern MenuItem *newNumericMenuItem(Menu *menu, unsigned char *setting,
                                    const MenuString *name,
                                    unsigned char minimum,
                                    unsigned char maximum,
                                    unsigned char divisor, const char *unit);

extern MenuItem *newStringsMenuItem(Menu *menu, unsigned char *setting,
                                    const MenuString *name,
                                    const MenuString *strings,
                                    unsigned char count);

#define newEnumeratedMenuItem(menu, setting, name, strings) \
  newStringsMenuItem(menu, setting, name, strings, ARRAY_COUNT(strings))
extern MenuItem *newBooleanMenuItem(Menu *menu, unsigned char *setting,
                                    const MenuString *name);

extern MenuItem *newFilesMenuItem(Menu *menu, const MenuString *name,
                                  const char *directory,
                                  const char *subdirectory,
                                  const char *extension, const char *initial,
                                  int none);

typedef void MenuToolFunction(void);
extern MenuItem *newToolMenuItem(Menu *menu, const MenuString *name,
...
extern int changeMenuSettingScaled(Menu *menu, unsigned int index,
                                   unsigned int count);
