...
extern int startSpeechDriverThread(volatile SpeechSynthesizer *spk,
                                   char **parameters);
...
extern int sayUtf8Characters(volatile SpeechSynthesizer *spk, const char *text,
                             const unsigned char *attributes, size_t length,
                             size_t count, SayOptions options);

extern int sayWideCharacters(volatile SpeechSynthesizer *spk,
                             const wchar_t *characters,
                             const unsigned char *attributes, size_t count,
                             SayOptions options);

extern int sayString(volatile SpeechSynthesizer *spk, const char *string,
                     SayOptions);

extern int canSetSpeechVolume(volatile SpeechSynthesizer *spk);
extern int setSpeechVolume(volatile SpeechSynthesizer *spk, int setting,
                           int say);
...
extern int setSpeechPitch(volatile SpeechSynthesizer *spk, int setting,
                          int say);

extern int canSetSpeechPunctuation(volatile SpeechSynthesizer *spk);
extern int setSpeechPunctuation(volatile SpeechSynthesizer *spk,
                                SpeechPunctuation setting, int say);

extern int haveSpeechDriver(const char *code);
extern const char *getDefaultSpeechDriver(void);
extern const SpeechDriver *loadSpeechDriver(const char *code,
                                            void **driverObject,
