...
extern int asyncHandleSignal(int signalNumber, AsyncSignalHandler *newHandler,
...
extern int asyncWithSignalsBlocked(const sigset_t *mask,
                                   AsyncWithSignalsBlockedFunction *function,
                                   void *data);

extern int asyncWithSignalBlocked(int number,
                                  AsyncWithSignalsBlockedFunction *function,
                                  void *data);

extern int asyncWithAllSignalsBlocked(AsyncWithSignalsBlockedFunction *function,
                                      void *data);

extern int asyncWithObtainableSignalsBlocked(
    AsyncWithSignalsBlockedFunction *function, void *data);
...
#define ASYNC_SIGNAL_CALLBACK(name) \
  int name(const AsyncSignalCallbackParameters *parameters)
typedef ASYNC_SIGNAL_CALLBACK(AsyncSignalCallback);

extern int asyncMonitorSignal(AsyncHandle *handle, int signal,
