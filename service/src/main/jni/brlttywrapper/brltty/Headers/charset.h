...
extern void convertUtf8ToWchars(const char **utf8, wchar_t **characters,
                                size_t count);
extern char *makeUtf8FromWchars(const wchar_t *characters, unsigned int count,
                                size_t *length);

extern wint_t convertCharToWchar(char c);
extern int convertWcharToChar(wchar_t wc);

extern size_t convertTextToWchars(wchar_t *characters, const char *text,
                                  size_t size);
...
extern int writeUtf8Characters(FILE *stream, const wchar_t *characters,
                               size_t count);
