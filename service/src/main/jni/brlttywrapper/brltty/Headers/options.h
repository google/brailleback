...
#define END_OPTION_TABLE                                                       \
  {.letter = 'h',                                                              \
   .word = "help",                                                             \
   .description = strtext(                                                     \
       "Print a usage summary (commonly used options only), and then exit.")}, \
  {                                                                            \
    .letter = 'H', .word = "full-help",                                        \
    .description =                                                             \
        strtext("Print a usage summary (all options), and then exit.")         \
  }                                                                            \
  }                                                                            \
  ;
...
extern ProgramExitStatus processOptions(const OptionsDescriptor *descriptor,
                                        int *argumentCount,
                                        char ***argumentVector);
