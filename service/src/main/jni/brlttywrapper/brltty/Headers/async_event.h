...
#define ASYNC_EVENT_CALLBACK(name) \
  void name(const AsyncEventCallbackParameters *parameters)
...
extern AsyncEvent *asyncGetProgramEvent(AsyncEvent **event, const char *name,
                                        AsyncEventCreator *createEvent,
                                        void *data);
