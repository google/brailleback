...
extern unsigned int getIntegerSpeechVolume(unsigned char setting,
                                           unsigned int normal);
extern unsigned int getIntegerSpeechRate(unsigned char setting,
                                         unsigned int normal);
extern unsigned int getIntegerSpeechPitch(unsigned char setting,
                                          unsigned int normal);
