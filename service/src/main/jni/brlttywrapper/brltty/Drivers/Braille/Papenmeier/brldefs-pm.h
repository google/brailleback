...
#define PM_P1_XMT_BRLWRITE                                        \
  0X0200 /* how to write each braille cell:                       \
          * 0 = convert data according to braille table (default) \
          * 1 = write directly                                    \
          * 2 = mark end of braille display                       \
          */
#define PM_P1_XMT_BRLCELL                                                 \
  0X0300                         /* description of each braille cell:     \
...
#define PM_P1_XMT_LCDUSAGE                                          \
  0X0500                         /* source of LCD data:             \
...
#define PM_P1_XMT_LENFBSEQ \
  0X0603 /* length of feedback sequence for speech synthesizer */
#define PM_P1_XMT_LENKPSEQ 0X0604 /* length of keypad sequence */
#define PM_P1_XMT_TIMEK1K2 \
  0X0605 /* key code suppression time for moving from K1 to K2 (left) */
#define PM_P1_XMT_TIMEK3K4 \
  0X0606 /* key code suppression time for moving from K3 to K4 (up) */
#define PM_P1_XMT_TIMEK5K6 \
  0X0607 /* key code suppression time for moving from K5 to K6 (right) */
#define PM_P1_XMT_TIMEK7K8 \
  0X0608 /* key code suppression time for moving from K7 to K8 (down) */
#define PM_P1_XMT_TIMEROUT 0X0609 /* routing time interval */
#define PM_P1_XMT_TIMEOPPO \
  0X060A /* key code suppression time for opposite movements */
