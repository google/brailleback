...
#define KEY_FUNCTION_HOME  // FUNCTION_KEY(0XXX) /* Home (M)       p 1,3,4,7 L/R
                           // */
#define KEY_FUNCTION_UP_ARROW  // FUNCTION_KEY(0XXX) /* Up arrow (U)   p 1,3,6,7
                               // L/R */
#define KEY_FUNCTION_PAGE_UP  // FUNCTION_KEY(0XXX) /* Page up (P)    p
                              // 1,2,3,4,7 L/R */
#define KEY_FUNCTION_LEFT_ARROW  // FUNCTION_KEY(0XXX) /* Left arrow (V) p
                                 // 1,2,3,6,7 L/R */
#define KEY_FUNCTION_RIGHT_ARROW  // FUNCTION_KEY(0XXX) /* Right arrow(R) p
                                  // 1,2,3,5,7 L/R */
#define KEY_FUNCTION_ENDN  // FUNCTION_KEY(0XXX) /* End (N)        p 1,3,4,5,7
                           // L/R */
#define KEY_FUNCTION_DOWN_ARROW  // FUNCTION_KEY(0XXX) /* Down arrow (W) p
                                 // 2,4,5,6,7 L/R */
#define KEY_FUNCTION_PAGE_DOWN  // FUNCTION_KEY(0XXX) /* Page down (O)  p
                                // 1,3,5,7 L/R */
#define KEY_FUNCTION_DELETE  // FUNCTION_KEY(0XXX) /* Delete (T)     p 2,3,4,5,7
                             // L/R */
#define KEY_FUNCTION_LEFT_ARROW_GRAY  // FUNCTION_KEY(0XXX) /* Left arrow, gr p
                                      // 1,2,3,6,7,8 L/R */
#define KEY_FUNCTION_PRINT_SCREEN  // FUNCTION_KEY(0XXX) /* Print screen   p
                                   // 2,4,6,8 L/R */
#define KEY_FUNCTION_PAUSE_BREAK  // FUNCTION_KEY(0XXX) /* Pause/break    p
                                  // 4,5,6,8 L/R */
#define KEY_FUNCTION_BACKSPACE  // FUNCTION_KEY(0XXX) /* Backspace      p
                                // 1,3,5,8 L/R */
...
#define KEY_FUNCTION_INSERT \
  FUNCTION2_KEY(0X97)           /* Insert (S)     p 2,3,4,7 L/R */
#define KEY_FUNCTION_HOME_GRAY  // FUNCTION2_KEY(0X97) /* Home, gray     p
                                // 1,3,4,7,8 L/R */
#define KEY_FUNCTION_UP_ARROW_GRAY \
  FUNCTION2_KEY(0X98) /* Up arrow, gray p 1,3,6,7,8 L/R */
#define KEY_FUNCTION_PAGE_UP_GRAY \
  FUNCTION2_KEY(0X99) /* Page up, gray  p 1,2,3,4,7,8 L/R */
#define KEY_FUNCTION_DOWN_ARROW_GRAY \
  FUNCTION2_KEY(0X9A) /* Down arrow, gr p 2,4,5,6,7,8 L/R */
#define KEY_FUNCTION_RIGHT_ARROW_GRAY \
  FUNCTION2_KEY(0X9D) /* Right arrow,gr p 1,2,3,5,7,8 L/R */
#define KEY_FUNCTION_END_GRAY \
  FUNCTION2_KEY(0X9F) /* End, gray      p 1,3,4,5,7,8 L/R */
#define KEY_FUNCTION_PAGE_DOWN_GRAY \
  FUNCTION2_KEY(0XA1) /* Page down,gray p 1,3,5,7,8 L/R */
#define KEY_FUNCTION_INSERT_GRAY \
  FUNCTION2_KEY(0XA2) /* Insert, gray   p 2,3,4,7,8 L/R */
#define KEY_FUNCTION_DELETE_GRAY \
  FUNCTION2_KEY(0XA3) /* Delete, gray   p 2,3,4,5,7,8 L/R */
