...
/////////////////////////////////////////////////////////////////
// LINK PROTOCOL - KEY
// this key is operational only if subkey is 'B','D' or 'B','S'
// (LP_BRAILLE_DISPLAY,LP_BRAILLE_DISPLAY_STATIC/LP_BRAILLE_DISPLAY_DYNAMIC
...
#define LP_TRANSFERT_PARAMETERS \
  'p'  // Request to receive or send the assignment table.
//#define LP_TRANSFERT_TABLE          't' // Request to receive or send the
//assignment table.
