...
public class UsbHelper {
  ...
  private static void makePermissionReceiver() {
    ...
    permissionIntent =
        PendingIntent.getBroadcast(usbContext, 0, new Intent(ACTION_USB_PERMISSION), 0);
  }
  ...
  public static UsbRequest enqueueRequest(
      UsbDeviceConnection connection, UsbEndpoint endpoint, byte[] bytes) {
