...
public class ScreenElementList extends ArrayList<ScreenElement> {
  ...
  public final void sortByVisualLocation() {
    Comparator<ScreenElement> comparator =
        new Comparator<ScreenElement>() {
          ...
          public int compare(ScreenElement element1, ScreenElement element2) {
            ...
            return (location1.top < location2.top)
                ? -1
                : (location1.top > location2.top)
                    ? 1
                    : (location1.left < location2.left)
                        ? -1
                        : (location1.left > location2.left)
                            ? 1
                            : (location1.right > location2.right)
                                ? -1
                                : (location1.right < location2.right)
                                    ? 1
                                    : (location1.bottom > location2.bottom)
                                        ? -1
                                        : (location1.bottom < location2.bottom) ? 1 : 0;
          }
        };
  ...
  public final ScreenElement find(
      ScreenElement.LocationGetter locationGetter, int left, int top, int right, int bottom) {
