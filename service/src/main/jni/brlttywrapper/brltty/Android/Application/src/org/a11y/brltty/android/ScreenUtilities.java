...
public final class ScreenUtilities {
  ...
  public static boolean isEditable(AccessibilityNodeInfo node) {
    if (ApplicationUtilities.haveSdkVersion(Build.VERSION_CODES.JELLY_BEAN_MR2)) {
      ...
      return LanguageUtilities.canAssign(
          android.widget.EditText.class, node.getClassName().toString());
    }
  }
  ...
  public static AccessibilityNodeInfo findNode(
      AccessibilityNodeInfo root, ScreenNodeTester tester) {
    if (root != null) {
  ...
  public static AccessibilityNodeInfo findSelectedNode(AccessibilityNodeInfo root) {
    ScreenNodeTester tester =
        new ScreenNodeTester() {
          @Override
