...
public class ScreenLogger {
  ...
  public final void addValue(
      List<CharSequence> values, boolean condition, CharSequence onValue, CharSequence offValue) {
  ...
  public final void addValue(List<CharSequence> values, boolean condition, CharSequence onValue) {
    addValue(values, condition, onValue, null);
  }

  public final void addValue(List<CharSequence> values, CharSequence value) {
...

    {
      ...
      if (ApplicationUtilities.haveSdkVersion(Build.VERSION_CODES.LOLLIPOP)) {
        ...
        if (ApplicationUtilities.haveSdkVersion(Build.VERSION_CODES.JELLY_BEAN)) {
          addValue(
              values,
              ((actions & AccessibilityNodeInfo.ACTION_NEXT_AT_MOVEMENT_GRANULARITY) != 0),
              "mvn");
          addValue(
              values,
              ((actions & AccessibilityNodeInfo.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY) != 0),
              "mvp");
        }

        if (ApplicationUtilities.haveSdkVersion(Build.VERSION_CODES.JELLY_BEAN)) {
          addValue(
              values, ((actions & AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT) != 0), "mhn");
          addValue(
              values, ((actions & AccessibilityNodeInfo.ACTION_PREVIOUS_HTML_ELEMENT) != 0), "mhp");
        }
        ...
        if (ApplicationUtilities.haveSdkVersion(Build.VERSION_CODES.JELLY_BEAN)) {
          addValue(
              values, ((actions & AccessibilityNodeInfo.ACTION_ACCESSIBILITY_FOCUS) != 0), "afs");
          addValue(
              values,
              ((actions & AccessibilityNodeInfo.ACTION_CLEAR_ACCESSIBILITY_FOCUS) != 0),
              "afc");
        }
  ...
  public final void logTreeProperties(AccessibilityNodeInfo root, CharSequence name) {
