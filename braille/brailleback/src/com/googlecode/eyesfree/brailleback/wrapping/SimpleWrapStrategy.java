...
/**
 * A simple wrap strategy in which lines are split by character if they are too
 * long to fit on a single line of the braille display. In this strategy, words
